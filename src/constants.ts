const InputFieldStyleClassName = "uppercase dark:bg-white appreance-none block rounded border px-4 py-3 mb-3 text-gray-900 focus:outline-gray-400 focus:bg-white"
